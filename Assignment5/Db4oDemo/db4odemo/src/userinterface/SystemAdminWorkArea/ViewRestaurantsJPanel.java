...
public class ViewRestaurantsJPanel extends javax.swing.JPanel {
    ...
    public ViewRestaurantsJPanel(JPanel container, Restaurant restaurant, RestaurantDirectory restaurantDirectory) {
        ...
        restaurantIdTextField.setText(String.valueOf(restaurant.getId()));
        managerNameTextField.setText(restaurant.getManager().toString());
    ...
    private void initComponents() {
        ...
        restaurantIdTextField.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        ...
        contactTextField.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        // TODO add your handling code here:
            //restaurant.setManager(managerNameTextField.getText());
            restaurant.setAddress(addressTextField.getText());
            restaurant.setNumber(contactTextField.getText());
