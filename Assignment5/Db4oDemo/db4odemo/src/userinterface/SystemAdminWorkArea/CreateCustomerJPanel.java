...
public class CreateCustomerJPanel extends javax.swing.JPanel {
    ...
    private void addCustomerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addCustomerBtnActionPerformed
        ...
        if(customerContactNoTextField.getText()== null || customerContactNoTextField.getText().equals(""))
        {
            JOptionPane.showMessageDialog(null, "Please enter data!");
            return;
        }
        
        if(customerAddressTextField.getText()== null || customerAddressTextField.getText().equals(""))
        {
            JOptionPane.showMessageDialog(null, "Please enter data!");
            return;
        }
