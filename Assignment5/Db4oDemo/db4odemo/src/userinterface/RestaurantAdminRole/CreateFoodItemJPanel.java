...
public class CreateFoodItemJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        itemNameTextField.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N

        itemDescriptionTextField.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N

        itemPriceTextField.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        double price = Double.parseDouble(itemPriceTextField.getText());
            Restaurant restaurant = system.getRestaurantDirectory().getRestaurantByManagerID(account.getEmployee().getId());//account.getEmployee().getName();
            menuDirectory.add(String.valueOf(restaurant.getId()),name,description,price);
