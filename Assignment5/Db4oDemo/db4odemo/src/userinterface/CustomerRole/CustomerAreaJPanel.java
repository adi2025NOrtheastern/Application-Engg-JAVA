...
public class CustomerAreaJPanel extends javax.swing.JPanel {
    ...
    public CustomerAreaJPanel(JPanel userProcessContainer, UserAccount account,EcoSystem business) {
        ...
        this.menuDirectory = business.getMenuDirectory();
    ...
    public void populateMenuTable(){
        ...
        for(FoodItem foodItem: menuDirectory.getMenuDirectory()){
            ...
            String restName=restaurantDirectory.getRestName(foodItem.getRestaurantId());
            if(!restName.equals(""))
            {
    ...
    public void populateRequestTable(){
        ...
        for(Order order: business.getOrderDirectory().getOrderDirectory()){
            if(order.getCustomer().getId()==(userAccount.getEmployee().getId())){
    ...
    private void initComponents() {
        ...
        enterpriseLabel1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        enterpriseLabel1.setText("Restaurant Menu");
        ...
        btnAddMsg.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(row >= 0){
            ...
            Restaurant restaurant = business.getRestaurantDirectory().getRestaurant(menuDirectory.getFoodItemByIndex(row).getRestaurantId());
            Customer customer = customerDirectory.getCustomerByCustomerId(userAccount.getEmployee().getId());
    ...
    private void btnAddMsgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddMsgActionPerformed
        ...
        Order order1 = (Order) workRequestJTable1.getValueAt(row, 9);
        
        
        RequestLabTestJPanel processWorkRequestJPanel = new RequestLabTestJPanel(userProcessContainer, order1);
