...
public class Lab7 {
    ...
    private void runAnalysis(){
        ...
        helper.getPostMostLikeComments();
        helper.getPostByMostComments();
        helper.getTop5InactiveUsrBasedOnPostNum();
        helper.getTop5InactiveUsrBasedOnComments();
        helper.getTop5InactiveUsrOverAll();
        helper.getTop5ActiveUsrOverAll();
    }
}
