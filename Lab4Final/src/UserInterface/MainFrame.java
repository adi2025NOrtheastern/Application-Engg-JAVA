...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jSplitPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 1029, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        setSize(new java.awt.Dimension(1071, 812));
    ...
    private void btnSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSupplierActionPerformed
        ...
        panelRight.add("SupplierLoginScreen",new LoginScreen(panelRight, adminUser.getSuppDir().getSupplierList()));
        layout.next(panelRight);*/
        LoginScreen panel=new LoginScreen(panelRight, adminUser.getSuppDir().getSupplierList(),jSplitPane1);
    ...
    private void btnCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCustomerActionPerformed
        // TODO add your handling code here:
        /*CardLayout layout = (CardLayout)panelRight.getLayout();
        panelRight.add("CustomerLoginScreen",new LoginScreen(panelRight, adminUser.getCustDir().getCustomerList()));
        layout.next(panelRight);*/
        LoginScreen panel = new LoginScreen(panelRight, adminUser.getCustDir().getCustomerList(),jSplitPane1);
        jSplitPane1.setRightComponent(panel);
    ...
    private void btnAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdminActionPerformed
        // TODO add your handling code here:
        /*CardLayout layout = (CardLayout)panelRight.getLayout();
        panelRight.add("AdminMainScreen",new AdminMainScreen(panelRight, (Admin)adminUser));
        layout.next(panelRight);*/
        AdminMainScreen panel = new AdminMainScreen(panelRight, (Admin)adminUser,jSplitPane1);
        jSplitPane1.setRightComponent(panel);
